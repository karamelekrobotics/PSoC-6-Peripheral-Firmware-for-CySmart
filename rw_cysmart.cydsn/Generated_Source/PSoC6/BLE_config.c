...
cy_stc_ble_gapp_disc_data_t cy_ble_discoveryData[0x01u] = {
    ...
    /* Peripheral configuration 0 */
    {
        { 0x02u, 0x01u, 0x06u, 0x05u, 0x09u, 0x52u, 0x42u,
        0x47u, 0x52u, 0x11u, 0x21u, 0x4Bu, 0x29u, 0xDBu,
        0xB1u, 0x4Au, 0xD1u, 0xF8u, 0x80u, 0x51u, 0x40u,
        0x22u, 0x93u, 0x45u, 0x05u, 0xFAu, 0x7Bu, 0x00u,
        0x00u, 0x00u, 0x00u }, /* uint8_t advertising_data[CY_BLE_MAX_ADV_DATA_LEN] */ 
        0x1Bu, /* uint8_t adv_data_length */ 
    },
};
...
static uint8_t cy_ble_attValues[0x1Cu] = {
    /* Device Name */
    (uint8_t)'R', (uint8_t)'B', (uint8_t)'G', (uint8_t)'R', 
    ...
    (uint8_t)'o', (uint8_t)'n', (uint8_t)'-', (uint8_t)'o', (uint8_t)'f', (uint8_t)'f', 
...
static const uint8_t cy_ble_attUuid128[][16u] = {
    /* LED */
    { 0x4Bu, 0x29u, 0xDBu, 0xB1u, 0x4Au, 0xD1u, 0xF8u, 0x80u, 0x51u, 0x40u, 0x22u, 0x93u, 0x45u, 0x05u, 0xFAu, 0x7Bu },
    /* GREEN */
    { 0x71u, 0xF2u, 0xA7u, 0x64u, 0xF6u, 0x64u, 0x33u, 0x85u, 0xE2u, 0x47u, 0x10u, 0x38u, 0x81u, 0x2Au, 0x96u, 0x51u },
    /* RED */
    { 0x7Au, 0x17u, 0x79u, 0x25u, 0xD1u, 0xC9u, 0xB4u, 0x98u, 0x9Au, 0x44u, 0x49u, 0xB5u, 0x7Eu, 0xBDu, 0xD1u, 0xBDu },
};
...
static cy_stc_ble_gatts_att_gen_val_len_t cy_ble_attValuesLen[0x0Du] = {
    ...
    { 0x0010u, (void *)&cy_ble_attUuid128[0] }, /* LED UUID */
    { 0x0010u, (void *)&cy_ble_attUuid128[1] }, /* GREEN UUID */
    { 0x0001u, (void *)&cy_ble_attValues[20] }, /* GREEN */
    { 0x0006u, (void *)&cy_ble_attValues[21] }, /* Characteristic User Description */
    { 0x0010u, (void *)&cy_ble_attUuid128[2] }, /* RED UUID */
    { 0x0001u, (void *)&cy_ble_attValues[27] }, /* RED */
};
...
static const cy_stc_ble_gatts_db_t cy_ble_gattDB[0x15u] = {
    ...
    { 0x0012u, 0x2A81u /* GREEN                               */, 0x09080100u /* wr    */, 0x0013u, {{0x0001u, (void *)&cy_ble_attValuesLen[9]}} },
    { 0x0013u, 0x2901u /* Characteristic User Description     */, 0x01020001u /* rd    */, 0x0013u, {{0x0006u, (void *)&cy_ble_attValuesLen[10]}} },
    { 0x0014u, 0x2803u /* Characteristic                      */, 0x00020001u /* rd    */, 0x0015u, {{0x0010u, (void *)&cy_ble_attValuesLen[11]}} },
    { 0x0015u, 0xBD7Eu /* RED                                 */, 0x09020001u /* rd    */, 0x0015u, {{0x0001u, (void *)&cy_ble_attValuesLen[12]}} },
};
