...
#define CY_BLE_ADV_PKT_0_INDEX_SERVICE_DATA_LED   (0x09u)
...
#define CY_BLE_LED_RED_CHAR_INDEX   (0x01u) /* Index of RED characteristic */


#define CY_BLE_LED_SERVICE_HANDLE   (0x0010u) /* Handle of LED service */
#define CY_BLE_LED_GREEN_DECL_HANDLE   (0x0011u) /* Handle of GREEN characteristic declaration */
#define CY_BLE_LED_GREEN_CHAR_HANDLE   (0x0012u) /* Handle of GREEN characteristic */
#define CY_BLE_LED_GREEN_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0013u) /* Handle of Characteristic User Description descriptor */
#define CY_BLE_LED_RED_DECL_HANDLE   (0x0014u) /* Handle of RED characteristic declaration */
#define CY_BLE_LED_RED_CHAR_HANDLE   (0x0015u) /* Handle of RED characteristic */
